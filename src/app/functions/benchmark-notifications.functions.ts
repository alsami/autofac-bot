...
import { RunningRequest } from '@autofac-bot/models';
import { Response } from 'node-fetch';
import { Context } from 'probot';

export async function notifiyRunningRequest(
  context: Context,
...
export async function notifiyInvalidBenchmarkName(
  context: Context,
...
export async function notifyRepositoryInfoRequestFailure(
  context: Context,
...
export async function notifyPullRequestInfoRequestFailure(
  context: Context,
...
export async function notifyBenchmarkApiUnavailable(
  context: Context
): Promise<void> {
  const repositoryInfoRequestFailureComment = context.issue({
...
export async function notifyBenchmarkRequestFailure(
  context: Context,
...
export async function notifyBenchmarkResults(
  context: Context,
  benchmarkRequestResponse: Response
): Promise<void> {
